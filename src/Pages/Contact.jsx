...
function Contact() {
  ...
  <main>
    {/* Start Hero Section */}
<section className="cs_hero cs_style_3 cs_type_1 cs_filled_bg cs_center text-center" data-src="assets/img/bg/hero_bg_5.svg">
  <div className="container">
    <div className="cs_height_45 cs_height_lg_45" />
    <h1 className="cs_hero_title cs_font_92 cs_extra_bold wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"><span className="cs_gradient_text_2">Contact Us</span></h1>
  ...
  <div className="container">
    <div className="row">
      <div className="col-lg-8 offset-lg-2">
        <h4 className="cs_form_title cs_font_36 cs_semi_bold m-0">Lets Talk</h4>
        <p className="cs_form_text">Got a project in mind? Fill in the form or send us.</p>
        ...
        <form action="https://portm-html.vercel.app/post">
          ...
          <div className="cs_height_25 cs_height_lg_25" />
          <select className="form-control cs_select_option" name="budget-range" id="budget-range" required>
          ...
          <div className="cs_height_25 cs_height_lg_25" />
          <textarea className="form-control" name="message" placeholder="Your message" cols={30} rows={5} required defaultValue={""} />
          <div className="cs_height_25 cs_height_lg_25" />
          <button type="submit" className="cs_btn cs_style_1 cs_primary_font"><span>Send Message</span></button>
        </form>
      </div>
    </div>
  </div>
