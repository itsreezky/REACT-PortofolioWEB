      ...
      <div className="cs_blog cs_style_4">
        <div className="row align-items-center">
          <div className="col-lg-6">
            <a href="blog-details.html" className="cs_image_box cs_style_4 cs_radius_10 overflow-hidden">
          ...
          <div className="col-lg-6">
            <div className="cs_pl_50">
              ...
              <h3 className="cs_blog_title cs_font_36 cs_semi_bold"><a className="cs_accent_color_2_hover" href="blog-details.html">How to design a user-centric mobile application?</a></h3>
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  <span className="cs_font_16">26 July 2022</span>
                  <a href="blog-details.html" className="cs_blog_author_name cs_accent_color_2 cs_accent_color_2_hover cs_text_btn cs_type_2 cs_font_16">John
                    Smith</a>
                </div>
                <a href="blog-details.html" className="cs_circle_btn cs_style_1 cs_accent_color cs_center rounded-circle">
        ...
        <div className="cs_blog_wrap">
          <div className="cs_blog cs_style_1 cs_transition_4">
            <div className="flex-none">
              <a href="blog-details.html" className="cs_blog_thumbnail cs_zoom">
            ...
            <div className="cs_blog_info">
              <div className="cs_blog_date text-nowrap cs_secondary_color">
                ...
                <span className="cs_font_16 d-inline-block">Jul 2022</span>
              </div>
              <h2 className="cs_blog_title cs_font_20 cs_semi_bold"><a className="cs_accent_color_2_hover" href="blog-details.html">10
                  common UI design mistakes to avoid as a beginner.</a></h2>
              <span className="cs_secondary_color">10 mins read</span>
              <a href="blog-details.html" className="cs_circle_btn cs_style_1 cs_type_1 cs_accent_color_2 cs_center rounded-circle">
                <svg width={11} height={11} viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1 10L10 1" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                  <path d="M1 1H10V10" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                </svg>
          ...
          <div className="cs_blog cs_style_1 cs_transition_4">
            ...
            <div className="cs_blog_info">
              ...
              <h2 className="cs_blog_title cs_font_20 cs_semi_bold"><a className="cs_accent_color_2_hover" href="blog-details.html">How to
          ...
          <div className="cs_blog cs_style_1 cs_transition_4">
            ...
            <div className="cs_blog_info">
              ...
              <h2 className="cs_blog_title cs_font_20 cs_semi_bold"><a className="cs_accent_color_2_hover" href="blog-details.html">Product
