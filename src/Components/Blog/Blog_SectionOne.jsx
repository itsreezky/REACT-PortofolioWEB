            ...
            <div className="cs_pl_50">
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <a href="#" className="cs_blog_author_name cs_accent_color_2 cs_accent_color_2_hover cs_text_btn cs_type_2 cs_font_16">Reezky</a>
                </div>
                <a href="#" className="cs_circle_btn cs_style_1 cs_accent_color cs_center rounded-circle">
