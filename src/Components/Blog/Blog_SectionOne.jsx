      ...
      <div className="cs_blog cs_style_4">
        <div className="row align-items-center">
          <div className="col-lg-6">
            <a href="/REACT-PortofolioWEB/blog" className="cs_image_box cs_style_4 cs_radius_10 overflow-hidden">
          ...
          <div className="col-lg-6">
            <div className="cs_pl_50">
              ...
              <h3 className="cs_blog_title cs_font_36 cs_semi_bold"><a className="cs_accent_color_2_hover" href="/REACT-PortofolioWEB/blog">How to design a user-centric mobile application?</a></h3>
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <a href="/REACT-PortofolioWEB/blog" className="cs_blog_author_name cs_accent_color_2 cs_accent_color_2_hover cs_text_btn cs_type_2 cs_font_16">Reezky</a>
                </div>
                <a href="/REACT-PortofolioWEB/blog" className="cs_circle_btn cs_style_1 cs_accent_color cs_center rounded-circle">
